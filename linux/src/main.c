...
static void on_app_new(GSimpleAction *action, GVariant *param,
                       gpointer user_data) {
  g_print("App: New\n");
}

static void on_app_open(GSimpleAction *action, GVariant *param,
                        gpointer user_data) {
  g_print("App: Open\n");
}

static void on_app_save(GSimpleAction *action, GVariant *param,
                        gpointer user_data) {
  g_print("App: Save\n");
}

static void on_app_save_as(GSimpleAction *action, GVariant *param,
                           gpointer user_data) {
  g_print("App: Save As\n");
}

static void on_app_quit(GSimpleAction *action, GVariant *param,
                        gpointer user_data) {
  GApplication *app = G_APPLICATION(user_data);
  g_application_quit(app);
}

static void on_app_connect(GSimpleAction *action, GVariant *param,
                           gpointer user_data) {
  g_print("App: Connect\n");
}

static void on_app_disconnect(GSimpleAction *action, GVariant *param,
                              gpointer user_data) {
  g_print("App: Disconnect\n");
}

static void on_app_documentation(GSimpleAction *action, GVariant *param,
                                 gpointer user_data) {
  g_print("App: Documentation\n");
}

static void on_app_about(GSimpleAction *action, GVariant *param,
                         gpointer user_data) {
  g_print("App: About\n");
}
...
int main(int argc, char **argv) {
  GtkApplication *app =
      gtk_application_new("com.example.navbar", G_APPLICATION_DEFAULT_FLAGS);
